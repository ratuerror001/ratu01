 ...
 ⚡ crack sedang berjalan... 
	...
	def UA(self):
		try:
			...
			uas = ("Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36 Edg/121.0.0.0 Unique/97.7.7239.70")
			open('ugent.txt','w').write(uas)
